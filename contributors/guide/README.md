...
- [Getting Started](#getting-started)
  ...
  - [Smarter Contributor Playground](#kubernetes-contributor-playground)
...
This guide will help you understand the overall organization of the [Smarter
...
Welcome to Smarter! This guide is broken up into the following sections.
It is recommended that you follow these steps in order:

- [Welcome](#welcome) - this page
- [Prerequisites](#prerequisites) - tasks you need to complete before
  you can start contributing to Smarter
...
Before submitting code to Smarter, you should first complete the following
...
Before you can contribute to Smarter, you will need to sign the
...
Smarter is a community project. Consequently, it is wholly dependent on its
...
## Smarter Contributor Playground

If you are looking for a safe place, where you can familiarize yourself with
the pull request and issue review process in Smarter, then the
[Smarter Contributor Playground] is the right place for you.
...
Smarter is a large, lively, friendly open-source community. As many open
...
processes and roles. Please consider joining Smarter, and making your way
up the contributor ladder!

### Communication

- [General Information] relating to Smarter communication policies

### Events

Smarter participates in KubeCon + CloudNativeCon, held three times per year
...
All Smarter meetups follow the general [Cloud Native Computing Foundation Guidelines]
You may also contact CNCF Staff driving the Community Groups (previously known
as Meetups) program by email (meetups@cncf.io)

### Mentorship

Learn more about the Smarter [mentoring initiatives].
...
- [OWNERS files] - The Smarter organizations are managed with OWNERS files,
...
[Smarter Contributor Playground]: https://github.com/kubernetes-sigs/contributor-playground/blob/master/README.md
