# Шпаргалка для контриб'юторів Smarter

Список загальних джерел для контриб'юторів Smarter, корисні поради, прийоми та найкращі практики, що застосовуються у Smarter. Це "TL;DR", або стислий довідник корисної інформації, що має на меті покращити ваш досвід контриб'ютора на GitHub.

**Зміст**

- [Шпаргалка для контриб'юторів Smarter](#шпаргалка-для-контрибюторів-kubernetes)
...
- [Керівництво для контриб'юторів] - З чого почати свій внесок до проекту Smarter.
- [Керівництво для розробників] - Як зробити свій внесок безпосередньо у код проекту Smarter.
...
- [Календар] - Перегляд усіх подій спільноти Smarter (зустрічі SIG та робочих груп, події, тощо)
- [kubernetes-dev] - Поштова розсилка для розробників Smarter.
- [Smarter форум] - Офіційний форум Smarter.
- [Канали Slack] - Офіційний Slack Smarter.
- [Stack Overflow] - Платформа, де кінцеві користувачі Smarter можуть ставити свої запитання.
- [YouTube канал] - Офіційний канал спільноти Smarter.

### Робочий процес

- [Prow] - Smarter CI/CD система.
- [Tide] - Prow плаґін для управління процесом злиття змін до основної гілки репозиторія (merge) і тестами. [Tide Dashboard]
- [Команди бота] - Команди для взаємодії з ботами Smarter (наприклад:
  `/cc`, `/lgtm` і `/retest`)
- [GitHub мітки] - Список міток, які використовуються в проекті Smarter
- [Пошук у коді Smarter], за підтримки [@dims]
...
- conduct@kubernetes.io - Написати листа до Комітету з контролю поведінки в Smarter, приватна розсилка.
...
- [Smarter Patch Release] Розклад патч-релізів Smarter і контактна інформація команди.
...
Перш ніж зробити свій внесок, ви повинні [підписати Ліцензійну угоду учасника (CLA)][cla]. Ваш внесок до проекту Smarter може бути прийнято _лише_ за умови, що ви чи ваша компанія підписали CLA.
...
[інструкцією із усунення несправностей], повідомте про проблему до [Stack Overflow] чи [Smarter форум].
...
- Проставте відповідні [мітки]. Якщо ви не впевнені, бот [k8s-ci-robot][prow]
  ([Smarter CI bot][prow]) відповість на ваш issue і запропонує мітки, необхідні для пріоритизації вашого питання.
...
Після того, як ви зробили запит на прийняття змін, Smarter CI-платформа [Prow] виконує ряд тестів. У разі, якщо хоча б один із тестів завершився невдало, бот [k8s-ci-robot][prow] опублікує посилання на невдалі тести і наявні логи у відповіді на PR.

Додання нових комітів у ваш PR автоматично перезапускає тести.

Інколи можуть виникнути складнощі у роботі Smarter CI-платформи. Це може статися з багатьох причин, навіть якщо ваш код успішно пройшов локальні тести. Ви можете перезапустити тести командою `/retest`.

Детальніше про вирішення проблем, пов’язаних із певними тестами, дивіться в [керівництві з тестування].

### Мітки

Smarter використовує [мітки] для розподілу Issues та Pull Requests за категоріями та для визначення пріоритетності їх виконання. Використання відповідних міток сприятиме ефективній пріоритизації вашого issue чи PR.
...
[Пошук у коді Smarter]: https://cs.k8s.io/
...
[Smarter форум]: https://discuss.kubernetes.io/
