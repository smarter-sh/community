...
The goal of this group is to define a standardized set of capabilities,  APIs, and configurations that a Smarter cluster must offer to reliably and efficiently run AI/ML workloads.
